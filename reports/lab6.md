...
Уточнение: при первой (мало обдуманной) попытке привести листинг кода хука, и дальнейшего коммита - ничего не вышло, ибо в тексте отчета были найдены запрещенные слова.
